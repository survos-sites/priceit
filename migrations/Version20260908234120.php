 ...
 */
final class Version20260908234120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item ADD value_estimates JSON DEFAULT \'{}\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item DROP value_estimates');
    }
}
